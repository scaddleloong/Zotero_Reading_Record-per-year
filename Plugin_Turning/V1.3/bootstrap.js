...
Date: 2026/06/24
bootstrap.js V1.3: add AI_QA reader integration (selection popup)
...
async function startup({ id, version, rootURI }) {
    ...
    Services.scriptloader.loadSubScript(rootURI + "reader.js");
    ...
    // Register AI_QA button on the PDF reader's text-selection popup
    try {
        registerAIQAReader();
    } catch (e) {
        Zotero.debug("reader init error: " + e);
    }
